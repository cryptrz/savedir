This script creates a copy of a folder of your choice. You can add directly the path as argument like ```sh savedir.sh /home/toto/Downloads``` or you can just type ```sh savedir.sh``` for an interactive usage. 
